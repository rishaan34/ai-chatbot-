...
(function () {
	...
	var localeAttributes = setInterval(function () {
		...
		elemtentsWithDataAttr = Array.prototype.slice.call(document.querySelectorAll('*[data-content]')).filter(function(item) { return item.innerText === ''});
	...
	Locale.changeHTMLStrings = function () {
		...
		if (title_translated_mtrsfix === false && (typeof document.title === 'string') && (document.title.length > 0)) {
